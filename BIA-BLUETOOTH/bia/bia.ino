...
String numeroSerie = "TIAANBRIOYRK2", versionFirmware = "Firmware: 3.0", payloadConteo = "";
char ruta[] = "", unidad[] = "";
...
Boton completo(12, 8, 0, 2, "COMPLETO");
...
void BuscarWiFi(void *parameter)
{
  ...
  while (true)
  {
    ...
    {
      if (contadorIntentaReconexion >= intentaReconexion && wifi_activo_by_bluetooth == false)
      {
