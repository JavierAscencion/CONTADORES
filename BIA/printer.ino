...
void impresionBoleto(int cuenta, String id, float costo){ 
  ...
  */
  ...
  serialImpresora.printf("TARIFA: $%.2f\r\n", costo);
  ...
  serialImpresora.print(  now.hour());serialImpresora.print(":");serialImpresora.print(now.minute());serialImpresora.print(":");serialImpresora.print(now.second());
  serialImpresora.print(" ");
  serialImpresora.print(now.year());serialImpresora.print("/");serialImpresora.print(now.month());serialImpresora.print("/");serialImpresora.println(now.day());
  ...
  serialImpresora.write('\x1D'); serialImpresora.write('\x28'); serialImpresora.write('\x6B');
  serialImpresora.write('\x03'); serialImpresora.write('\x00'); serialImpresora.write('\x31');
  serialImpresora.write('\x43');
  serialImpresora.write('\x04');  //Ancho del QR
  //QR: Memoria
  serialImpresora.write('\x1D'); serialImpresora.write('\x28'); serialImpresora.write('\x6B');
  serialImpresora.write(strlen("www.accesa.me")+3);  //LongitudQR+3
  serialImpresora.write('\x00'); serialImpresora.write('\x31');
  serialImpresora.write('\x50'); serialImpresora.write('\x30');
  //QR:Data and imprimir
  serialImpresora.print("www.accesa.me");
  serialImpresora.write('\x1D'); serialImpresora.write('\x28'); serialImpresora.write('\x6B');
  serialImpresora.write('\x03'); serialImpresora.write('\x00'); serialImpresora.write('\x31');
  serialImpresora.write('\x51'); serialImpresora.write('\x30');
  /*
  for(byte i=0; i<2; i++){
  serialImpresora.write(IMPT_SIZE_CHAR[i]);
  }
...
//        }
    ...
    serialImpresora.write(0x01);
    serialImpresora.printf("TARIFA: $9.00\r\n"); //CAMBIAR CADA NUEVO PROYECTO
