...
String numeroSerie = "TIAIQH6AWRBW6", versionFirmware = "Firmware: 2.0", payloadConteo="";
char ruta[] = "CENTENARIO-CENTRO", unidad[] = "05";
String VENTAS = "2222608242", REPORTES="2283617583";
...
const char* ssid     = "INFINITUM0D9D_2.4";
const char* pass = "FD6vab2XJ8";
...
Boton completo(12, 9.00, 0, 2, "COMPLETO");
